...
@export var npc_name: String = "Old Man"
@export var portrait_texture: Texture2D
@export var initial_greeting: String = "It's a good day to go fishing.."
@export_multiline var persona: String = "You are a cheerful old man"
