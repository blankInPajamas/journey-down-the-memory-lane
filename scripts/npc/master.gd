...
@export var initial_greeting: String = "So much for peace and quiet, what do you want?"
@export_multiline var persona: String = "You are a sage old, irritable retired man"
