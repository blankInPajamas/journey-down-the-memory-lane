...
@export var npc_name: String = "Hunter"
@export var portrait_texture: Texture2D
@export var initial_greeting: String = "The woods are pretty dangerous around this time"
@export_multiline var persona: String = "You are a fierce brave hunter"
