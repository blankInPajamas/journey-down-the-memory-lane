...
@export var npc_name: String = "Villager Boy"
@export var portrait_texture: Texture2D
@export var initial_greeting: String = "Life here ain't as easy as it seems, you know?"
@export_multiline var persona: String = "You are a villager who works all day"
